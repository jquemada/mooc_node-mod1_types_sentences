...
describe("mooc_node-mod1_types_sentences", function () {
    ...
    it(`1: Checking that the assignment file exists...`, async function () {
        this.score = 0.5;
    ...
    it(`2: Running 'mooc_node-mod1_types_sentences.js'`, async function () {
        this.score = 0.5;
        if (error_critical) {
    ...
    it(`3: Checking the output length`, async function () {
        this.score = 1.5;
        if (error_critical) {
            this.msg_err = error_critical;
            should.not.exist(error_critical);
    ...
    it(`4: Checking the initial greeting`, async function () {
        this.score = 1.5;
        if (error_critical) {
            this.msg_err = error_critical;
            should.not.exist(error_critical);
    ...
    it(`5: Checking that the PI value is printed`, async function () {
        this.score = 1.25;
        if (error_critical) {
            this.msg_err = error_critical;
            should.not.exist(error_critical);
    ...
    it(`6: Checking the equivalence table`, async function () {
        this.score = 1.25;
        if (error_critical) {
            this.msg_err = error_critical;
            should.not.exist(error_critical);
    ...
    it(`7: Checking the equivalence table for odd numbers between 10 and 20`, async function () {
        this.score = 1.25;
        if (error_critical) {
            this.msg_err = error_critical;
            should.not.exist(error_critical);
    ...
    it(`8: Checking that unicode characters are printed correctly`, async function () {
        this.score = 1.25;
        if (error_critical) {
            this.msg_err = error_critical;
            should.not.exist(error_critical);
    ...
    it(`9: Checking that the farewell sentence is printed`, async function () {
        this.score = 1.5;
        if (error_critical) {
            this.msg_err = error_critical;
            should.not.exist(error_critical);
